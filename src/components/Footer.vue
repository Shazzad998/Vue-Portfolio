        ...
        <div class="mt-6 tracking-widest md:col-start-1 md:row-start-1">
          <div class="footer-text flex justify-center">
            ...
            >
              md.
              <span
                class="text-3xl font-bold text-zinc-100 sm:text-4xl md:text-3xl"
                >shazzad<span
                  class="text-xl font-medium text-zinc-300 sm:text-2xl md:text-xl"
                  >ul
                </span></span
          ...
          <div class="footer-text mt-2 text-center text-xs text-zinc-400">
...
onMounted(() => {
  let tl = animate.timeline({
    ...
    scrollTrigger: { trigger: ".footer-bg", start: "top bottom" },
  });

  tl.from(".footer-bg", {
    opacity: 0,
  })
    .from(".footer-text", { opacity: 0, stagger: 0.2 }, "-=.8")
    .from(".footer-icon a", { opacity: 0, stagger: 0.1 }, "-=.8");
});
</script>
